...
Shader "CelNoir/Standard"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "CelNoirStandardCoreForward.hlsl"
        ...
        // ------------------------------------------------------------------
        //  Deferred pass
		//  This is identical to the Unity standard shader's deferred pass, since of course there's not any shading happening here.
        ...
        Pass
        {
            ...
            #pragma fragment fragDeferred_CelNoir
