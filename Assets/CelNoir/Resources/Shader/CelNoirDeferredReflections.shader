/*
    CelNoir deferred reflection shader
...
Shader "CelNoir/Hidden/DeferredReflections" {
Properties {
    _SrcBlend ("", Float) = 1
    _DstBlend ("", Float) = 1
}
...
half4 frag (unity_v2f_deferred i) : SV_Target
{
    ...
    half3 rgb = BRDF2_CelNoir_Crushed(0, data.specularColor, oneMinusReflectivity, data.smoothness, data.normalWorld, -eyeVec, light, ind).rgb;
